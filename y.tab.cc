...
union YYSTYPE
{
#line 54 "shell.y" /* yacc.c:355  */

  char        *string_val;
  // Example of using a c++ type in yacc
  std::string *cpp_string;

#line 178 "y.tab.cc" /* yacc.c:355  */
};
...
{
       0,    88,    88,    92,   100,   121,   122,   126,   134,   135,
     140,   146,   156,   163,   169,   174,   184,   185,   190,   193,
     197,   202,   203,   208,   209
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PIPE", "GREATGREAT", "LESS", "TWOGREAT", "GREATAMPERSAND",
  "GREATGREATAMPERSAND", "AMPERSAND", "$accept", "goal", "command_word",
  "argument_word", "arg_list", "cmd_and_args", "pipe_list", "io_modifier",
  "io_modifier_list", "background_opt", "command", "command_list", YY_NULLPTR
};
#endif
...
{
      10,    -4,    -6,    -6,     1,    -6,    -6,     7,    -6,     9,
      -6,    -6,    14,    15,    -5,    -6,    -6,    -6,    -6,    16,
      17,    18,    19,    20,    21,    -6,    -6,    22,    -6,    -6,
      -6,    -6,    -6,    -6,    -6
};
...
{
       0,     0,     3,    21,     0,     6,     9,    17,    23,     0,
      22,     1,     7,     0,    19,    24,     4,     5,     8,     0,
       0,     0,     0,     0,     0,    18,    16,     0,    11,    10,
      14,    15,    13,    12,    20
};
...
{
      19,    11,    10,    20,    21,    22,    23,    24,    25,    -2,
       1,     1,     2,     2,    13,     3,     3,    16,     2,    28,
      29,    30,    31,    32,    33,    18,     0,     0,    34,     0,
       0,     0,    15
};
...
{
       0,     1,     3,     6,    15,    16,    19,    20,    24,    25,
       6,     0,    18,     7,    22,    24,     3,    17,    19,     5,
       8,     9,    10,    11,    12,    13,    21,    23,     3,     3,
       3,     3,     3,     3,     6
};
...
#line 100 "shell.y" /* yacc.c:1646  */
    {
		// expand wildcards
		char * word = strdup(((yyvsp[0].cpp_string))->c_str());
...
#line 1414 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1423 "y.tab.cc" /* yacc.c:1646  */
    break;
